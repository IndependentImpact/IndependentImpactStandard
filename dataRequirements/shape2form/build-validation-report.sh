...
OUT_BASE="${OUT_BASE%/}"
OUT_ROOT="${OUT_ROOT:-$OUT_BASE/nias-shape2form/validation-report}"
SHAPES_FILE="$ROOT_DIR/dataRequirements/shape2form/validation-report-ui-shapes.ttl"
...
MERGED_FILE="$OUT_ROOT/validation-report-merged-ui-shapes.ttl"
...
printf 'shape2form validation report output:\n'
