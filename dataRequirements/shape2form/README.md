...
the local contract between shape2form and the semantic standard: it names the
...
```bash
cd dataRequirements/shape2form/pdd_workflow_shell
...
```bash
dataRequirements/shape2form/build-monitoring-report.sh
```
...
```bash
dataRequirements/shape2form/build-verification-report.sh
```
...
```bash
python3 dataRequirements/shape2form/verification_report/tool/export_verification_report_markdown.py \
...
2. `shape2form/*-ui-shapes.ttl` files project those paths into form capture.
...
- `dataRequirements/shape2form/workflows/pdd-design.yaml`
- `dataRequirements/shape2form/workflows/validation-report.yaml`
- `dataRequirements/shape2form/workflows/monitoring-report.yaml`
- `dataRequirements/shape2form/workflows/verification-report.yaml`
...
- `dataRequirements/shape2form/workflows/archive/pdd.yaml`
- `dataRequirements/shape2form/workflows/archive/validation-verification.yaml`
- `dataRequirements/shape2form/archive/validation-verification-ui-shapes.ttl`
- `dataRequirements/shape2form/archive/build-validation-verification.sh`
- `dataRequirements/shape2form/archive/validation_verification_report/tool/export_validation_verification_report_markdown.py`
...
```bash
OUT_ROOT=/tmp/nias-shape2form/monitoring-report \
dataRequirements/shape2form/build-monitoring-report.sh
```

This generates a separate Monitoring Report Flutter form bundle:

- `/tmp/nias-shape2form/monitoring-report/schema/forms.jsonld`
- `/tmp/nias-shape2form/monitoring-report/flutter/*.dart`
...
- `/tmp/nias-shape2form/validation-report/schema/forms.jsonld`
- `/tmp/nias-shape2form/validation-report/flutter/*.dart`
- `/tmp/nias-shape2form/verification-report/schema/forms.jsonld`
- `/tmp/nias-shape2form/verification-report/flutter/*.dart`
...
- `/tmp/nias-shape2form/pdd-design/schema/forms.jsonld`
- `/tmp/nias-shape2form/pdd-design/flutter/*.dart`
...
- `/tmp/nias-shape2form/pdd-workflow/schema/forms.jsonld`
- `/tmp/nias-shape2form/pdd-workflow/flutter/*.dart`
...
the PDD shape2form forms, compiles the no-server preview, and checks the
...
- Repeated review fields use a bounded UI maximum so `shape2form` renders
