...
OUT_BASE="${OUT_BASE%/}"
OUT_ROOT="${OUT_ROOT:-$OUT_BASE/nias-shape2form/pdd-design}"
SHAPES_FILE="$ROOT_DIR/dataRequirements/shape2form/pdd-design-ui-shapes.ttl"
...
printf 'shape2form PDD Design output:\n'
